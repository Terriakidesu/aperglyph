...
export const flowchartPlugin: DiagramPlugin = {
  ...
  shapes: [
    ...
    { id: 'document', type: 'document', label: 'Document', icon: 'text', defaultSize: { width: 180, height: 82 }, defaultData: { label: 'Document' } },
    { id: 'multiple-document', type: 'multiple-document', label: 'Multiple documents', icon: 'text', defaultSize: { width: 190, height: 90 }, defaultData: { label: 'Documents' } },
    { id: 'database', type: 'database', label: 'Database', icon: 'database', defaultSize: { width: 170, height: 92 }, defaultData: { label: 'Database' } },
    { id: 'stored-data', type: 'stored-data', label: 'Stored data', icon: 'database', defaultSize: { width: 180, height: 82 }, defaultData: { label: 'Stored data' } },
    { id: 'manual-input', type: 'manual-input', label: 'Manual input', icon: 'rounded-rectangle', defaultStyle: { fill: '#1f2e43', stroke: '#76b8ff' }, defaultData: { label: 'Manual input' } },
    { id: 'preparation', type: 'preparation', label: 'Preparation', icon: 'diamond', defaultSize: { width: 180, height: 82 }, defaultData: { label: 'Preparation' } },
    { id: 'predefined-process', type: 'predefined-process', label: 'Predefined process', icon: 'square', defaultSize: { width: 190, height: 78 }, defaultData: { label: 'Subprocess' } },
    { id: 'delay', type: 'delay', label: 'Delay', icon: 'rounded-rectangle', defaultSize: { width: 170, height: 72 }, defaultData: { label: 'Delay' } },
    { id: 'display', type: 'display', label: 'Display', icon: 'square', defaultSize: { width: 180, height: 82 }, defaultData: { label: 'Display' } },
    { id: 'connector', type: 'connector', label: 'Connector', icon: 'circle', defaultSize: { width: 72, height: 72 }, defaultData: { label: 'A' } },
    { id: 'off-page-connector', type: 'off-page-connector', label: 'Off-page connector', icon: 'diamond', defaultSize: { width: 120, height: 90 }, defaultData: { label: 'A' } },
  ],
