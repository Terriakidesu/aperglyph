...
export function HomeScreen({ onOpen, onInstall }: HomeScreenProps) {
  ...
  return (
    <main className="home-shell">
      ...
      <footer className="home-footer"><span><LayoutTemplate size={14} /> AperGlyph 0.11.0</span><span>Local-first · Open format · No account required</span><span className="footer-links">Guide &nbsp;·&nbsp; Privacy &nbsp;·&nbsp; Keyboard shortcuts</span></footer>
    </main>
  );
}
